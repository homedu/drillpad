...
function App() {
    ...
    return (
        <div style={style_App}>
            ...
            <input value={user} onChange={(e) => setUser(e.target.value)} style={{ width: '150px', marginRight: '5px', padding: '5px' }} disabled={loading} />
            <input value={quiz} onChange={(e) => setQuiz(e.target.value)} style={{ width: '150px', marginRight: '5px', padding: '5px' }} disabled={loading} />
            <input type="number" value={count} onChange={(e) => setCount(Number(e.target.value))} style={{ width: '50px', marginRight: '5px', padding: '5px' }} disabled={loading} />
